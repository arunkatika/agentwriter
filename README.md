Here’s a professional and well-structured **README.md** for your **YouTube Blog Writer** GitHub repository:
...
- ✍️ **Blog Writer Agent**: Converts extracted data into a clear, concise blog post using OPEN AI GPT-4.
- 🔗 **Tool Integration**: YouTubeChannelSearchTool is used for content extraction from any channel.
...
1. **Blog Researcher Agent**:  
   - Uses `YoutubeChannelSearchTool` to search a video from any channel based on a query topic  
